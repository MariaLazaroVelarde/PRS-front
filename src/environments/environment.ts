export const environment = {
     ...
     organizations: 'https://lab.vallegrande.edu.pe/jass/ms-organizations/api/organizations',
     ...
     zonas: 'https://lab.vallegrande.edu.pe/jass/ms-distribution/api/v2/zones',
